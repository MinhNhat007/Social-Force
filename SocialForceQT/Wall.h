...
/**
 * @brief The Wall class All methods involved with wall
 */
class Wall
{
  private:
  ...
  public:
    /**
     * @brief Wall contructor with parameters
     * @param line wall line
     */
    Wall(Line line) { this->line.copy(line); }

    /**
     * @brief getNearestPoint gets nearest point between line and point p
     * @param p point
     * @return nearest point at line
     */
    ...
    /**
     * @brief getLine receives wall line
     * @return wall line
     */
    Line getLine()
    {
